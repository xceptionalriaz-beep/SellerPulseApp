    ...
    <nav className="fixed top-0 left-0 right-0 z-50 transition-all duration-300"
      ...
      <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
        ...
        <div className="flex items-center gap-2.5 cursor-pointer" onClick={() => router.push('/')}>
          ...
          <span className="text-[18px] font-black tracking-tight" style={{ color: T.carbon }}>
            Riazify
          </span>
        </div>
        ...
        <div className="hidden md:flex items-center gap-6">
          ...
          <div className="relative" onMouseEnter={() => setToolsOpen(true)} onMouseLeave={() => setToolsOpen(false)}>
            <button className="flex items-center gap-1 text-[14px] font-medium transition-colors"
              ...
              <div className="flex items-start justify-between mb-4">
                <div>
                  ...
                  <div className="flex items-center gap-3 flex-wrap">
                    ...
                    <div className={`flex items-center gap-1 px-2.5 py-1 rounded-full border text-[10px] font-black transition-all duration-500`}
                ...
                <div className="flex bg-white p-1 rounded-lg border gap-0.5" style={{ borderColor: T.border }}>
                  {['7D','30D','90D','1Y'].map((t,i) => (
                    <button key={t} className="px-2.5 py-1 text-[10px] font-bold rounded-md"
                      style={{ background: i===1 ? T.white : 'transparent',
                               color: i===1 ? T.carbon : T.sage,
...
function SocialProofStrip() {
  ...
  return (
    <div className="py-4 border-y overflow-hidden"
         style={{ background: T.carbon, borderColor: T.black }}>
    ...
    <section className="py-24" style={{ background: T.surface }}>
      <div className="max-w-5xl mx-auto px-6 text-center">
        <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full border mb-6"
          ...
          <span className="text-[11px] font-black tracking-wider" style={{ color: T.limeDeep }}>
            DEAD STOCK PREVENTION ENGINE
          </span>
        </div>
        ...
        <p className="text-[17px] leading-relaxed max-w-2xl mx-auto mb-12" style={{ color: T.sage }}>
          ...
          <span className="font-semibold px-1.5 py-0.5 rounded" style={{ background: T.limePale, color: T.carbon }}>
            active wholesale listing counts
          </span>{' '}
        ...
        <div className="rounded-3xl border p-8 lg:p-12 max-w-3xl mx-auto"
          ...
          <div className="flex items-center justify-between mb-4">
            ...
            <span className="text-[11px] font-black px-3 py-1 rounded-full"
                  style={{ background: T.limeTint, color: T.limeDeep }}>LIVE</span>
          </div>
          <div className="h-4 rounded-full relative overflow-hidden mb-3" style={{ background: T.limeTint }}>
            <div className="absolute left-0 top-0 h-full rounded-full"
                 style={{ width: '24%', background: `linear-gradient(to right, ${T.limeDeep}, ${T.lime})`,
                          boxShadow: `0 0 12px rgba(143,255,0,0.6)` }} />
          </div>
              ...
              <div key={i}
                ...
                <div className="flex items-start justify-between">
                  ...
                  <span className="text-[10px] font-black px-2.5 py-1 rounded-full"
                        style={{ background: T.limePale, color: T.limeDeep }}>
                    {tool.badge}
                  </span>
                </div>
                <div>
                ...
                <div className="flex items-center gap-1.5 mt-auto text-[13px] font-bold transition-all"
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {[
            ...
            <div key={i} className="rounded-3xl border p-8 flex flex-col gap-5 relative overflow-hidden"
              ...
              <p className="text-[14px] leading-relaxed font-medium" style={{ color: T.carbon }}>
                {t.quote}
              </p>
      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {steps.map((s, i) => {
            const Icon = s.icon
            return (
              <div key={i} className="rounded-3xl border p-8 h-full"
                   style={{ background: T.white, borderColor: T.border }}>
            ...
            <div key={i} className="rounded-2xl border overflow-hidden transition-all"
              ...
              <button onClick={() => setOpen(open === i ? null : i)}
                ...
                <div className="w-6 h-6 rounded-full flex items-center justify-center shrink-0"
                  ...
                  {open === i
                    ? <Minus size={12} style={{ color: T.black }} />
                    : <Plus  size={12} style={{ color: T.limeDeep }} />}
                </div>
              </button>
              {open === i && (
  ...
  const plans = [
    {
      ...
      desc: 'Perfect for testing Riazify.',
      features: ['5 niche scans/day','Basic trend chart','Saturation meter','Profit calculator','Email alerts'],
      cta: 'Start Free', highlight: false,
    },
    {
      name: 'Pro', price: '$29', period: '/month',
      desc: 'For serious eBay scaling operators.',
      features: ['Unlimited niche scans','AI forecast projections','MAP compliance tracker','Competitor X-Ray','Title Builder Pro','CSV exports','Priority support'],
      cta: 'Start Pro Free →', highlight: true,
    },
    {
      name: 'Business', price: '$79', period: '/month',
      desc: 'For agencies and multi-account sellers.',
      features: ['Everything in Pro','5 user seats','API access','Custom webhooks','Dedicated success manager','White-label reports','SLA guarantee'],
          ...
          {plans.map((plan, i) => (
            <div key={i} className="rounded-3xl border p-8 flex flex-col gap-6 relative overflow-hidden"
              ...
              <button onClick={() => router.push('/auth/signup')}
                ...
                style={{
                  background:   plan.highlight ? T.lime    : T.limeTint,
                  color:        plan.highlight ? T.black   : T.limeDeep,
...
function WhoIsItFor() {
  const personas = [
    {
      emoji:    '🚀',
      title:    'New eBay Sellers',
      pain:     `You don't know which products to sell or how to avoid overcrowded niches that kill margins.`,
      solution: `Riazify's saturation meter and AI demand forecasting tells you exactly where to start — before you spend a single dollar on inventory.`,
      cta:      'Start for free →',
      stats:    [{ val: '< 30 sec', label: 'to first niche scan' }, { val: '5 scans', label: 'free every day' }],
    },
    {
      emoji:    '📈',
      title:    'Scaling Operators',
      pain:     `You're growing but flying blind — no reliable data on where demand is heading or when to restock.`,
      solution: `Riazify's hybrid AI regressor gives you 7, 30, and 90-day forecasts with confidence scores — so you source ahead of the curve, not behind it.`,
      cta:      'Upgrade to Pro →',
      stats:    [{ val: '98%', label: 'AI forecast accuracy' }, { val: '$4.2M+', label: 'revenue protected' }],
      highlight: true,
    },
    {
      emoji:    '🏢',
      title:    'Agencies & Resellers',
      pain:     'Managing multiple eBay accounts with no centralized intelligence layer is burning time and leaving money on the table.',
      solution: 'Riazify Business gives you 5 user seats, API access, white-label reports, and a dedicated success manager — everything agencies need to deliver results at scale.',
      cta:      'Contact Sales →',
      stats:    [{ val: '5 seats', label: 'per Business plan' }, { val: 'API', label: 'full access' }],
    },
  ]
    ...
    <section className="py-24" style={{ background: T.white }}>
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <h2 className="text-[36px] lg:text-[48px] font-black mb-4" style={{ color: T.limeDeep }}>
            Who Is Riazify For?<br/>
            <span style={{ color: T.carbon }}>Everyone Selling on eBay.</span>
          </h2>
          <p className="text-[17px] max-w-2xl mx-auto" style={{ color: T.sage }}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {personas.map((p, i) => (
            <div key={i} className="rounded-3xl border p-8 flex flex-col gap-6 relative overflow-hidden"
                 style={{
                   background:  p.highlight ? T.carbon : T.surface,
                   borderColor: p.highlight ? T.lime   : T.border,
              ...
              <div>
                ...
                <h3 className="text-[22px] font-black mt-3 mb-4"
                    style={{ color: p.highlight ? T.white : T.carbon }}>{p.title}</h3>

                {/* Pain point */}
                <div className="p-3.5 rounded-xl mb-4"
                     style={{ background: p.highlight ? 'rgba(239,68,68,0.1)' : '#FFF5F5',
                              border: '1px solid rgba(239,68,68,0.2)' }}>
                  <p className="text-[12px] font-semibold" style={{ color: '#DC2626' }}>
                    😤 The Problem:
                  </p>
                  <p className="text-[13px] mt-1" style={{ color: p.highlight ? '#fca5a5' : '#7f1d1d' }}>
                    {p.pain}
                  </p>
                </div>
                ...
                <div className="p-3.5 rounded-xl"
                     style={{ background: p.highlight ? 'rgba(143,255,0,0.08)' : T.limeTint,
                              border: `1px solid ${T.accentBorder}` }}>
                  <p className="text-[12px] font-semibold" style={{ color: T.limeDeep }}>
                    ✅ The Riazify Fix:
                  </p>
                  <p className="text-[13px] mt-1"
                     style={{ color: p.highlight ? '#d4f5a0' : T.carbon }}>{p.solution}</p>
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 gap-3">
                {p.stats.map((s, j) => (
                  <div key={j} className="p-3 rounded-xl text-center"
                       style={{ background: p.highlight ? 'rgba(255,255,255,0.06)' : T.white,
                                border: `1px solid ${p.highlight ? 'rgba(255,255,255,0.08)' : T.border}` }}>
                    <p className="text-[16px] font-black" style={{ color: p.highlight ? T.lime : T.limeDeep }}>
                      {s.val}
                    </p>
                    <p className="text-[10px] mt-0.5" style={{ color: p.highlight ? T.sage : T.sage }}>
                      {s.label}
                    </p>
                  </div>
                ))}
              ...
              <button className="w-full py-3.5 rounded-xl font-black text-[14px] transition-all hover:scale-105 mt-auto"
                      style={{
                        background:  p.highlight ? T.lime    : T.limeTint,
                        color:       p.highlight ? T.black   : T.limeDeep,
  ...
  const results = [
    {
      ...
      before:   'Spent 3 hours manually checking niches. Hit dead stock twice in one month.',
      after:    'Found a $12K/month niche in under 8 minutes on his first Riazify scan.',
      metric:   '$12K',
      label:    'niche found in 8 min',
      color:    T.limeDeep,
    },
    {
      avatar:   'J',
      name:     'James R.',
      role:     '7-Figure eBay Seller',
      before:   'Almost ordered 500 units of a pet grooming line with hidden saturation.',
      after:    'Riazify flagged the spike. Saved $3,500 in dead inventory on day one.',
      metric:   '$3.5K',
      label:    'dead stock avoided',
      color:    '#16a34a',
      highlight: true,
    },
    {
      ...
      before:   'Always sourcing reactively — buying after trends peaked and margins collapsed.',
      after:    'Used AI forecast to source 200 units 3 weeks early. Sold out in 4 days.',
      metric:   '200 units',
      label:    'sold out in 4 days',
      color:    T.limeMid,
    },
  ]
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {results.map((r, i) => (
            <div key={i} className="rounded-3xl border flex flex-col overflow-hidden"
                 style={{
                   background:  r.highlight ? T.carbon : T.white,
                   borderColor: r.highlight ? T.lime   : T.border,
              ...
              <div className="p-6 border-b" style={{ borderColor: r.highlight ? 'rgba(255,255,255,0.08)' : T.border }}>
                ...
                <p className="text-[13px] leading-relaxed italic"
                   style={{ color: r.highlight ? '#94a3b8' : T.sage }}>"{r.before}"</p>
              </div>
              ...
              <div className="p-6 flex-1">
                ...
                <p className="text-[13px] leading-relaxed mb-6"
                   style={{ color: r.highlight ? '#e2e8f0' : T.carbon }}>"{r.after}"</p>

                {/* Big metric */}
                <div className="p-4 rounded-2xl text-center mb-5"
                     style={{ background: r.highlight ? 'rgba(143,255,0,0.08)' : T.limeTint,
                              border: `1px solid ${T.accentBorder}` }}>
    ...
    <footer className="py-16 border-t" style={{ background: T.carbon, borderColor: '#1a2410' }}>
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8 mb-12">
          ...
          {[
            { title: 'Product', links: ['Features', 'Pricing', 'Changelog', 'Roadmap', 'Chrome Extension'] },
            ...
            <div key={col.title}>
              ...
              <div className="flex flex-col gap-2.5">
                {col.links.map(l => (
                  <a key={l} href="#" className="text-[13px] transition-opacity hover:opacity-100 opacity-60"
                     style={{ color: T.sage }}>{l}</a>
                ))}
              </div>
            </div>
          ))}
