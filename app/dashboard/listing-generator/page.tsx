    ...
    return (
        <KillSwitchGate switchTitle="Listing Generator">
            <div
                ...
                style={{ backgroundColor: '#f8f7ff' }}
            >
                {/* Page Header — only for empty + wizard views
            Dashboard view has its own header inside LgDashboard */}
                {(view === 'empty' || view === 'wizard') && (
                    <PageHeader
                        onNewListing={handleNewListing}
                        showNewButton={view !== 'wizard'}
                    />
                )}
                ...
                <div className="flex-1 overflow-auto min-h-0">
                    ...
                    {view === 'empty' && (
                        <EmptyState onStart={handleNewListing} />
                    )}
