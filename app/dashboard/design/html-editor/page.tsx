...
import {
    ChevronLeft, Code2, Layers, Save, X,
    ...
    return (
        <div className="flex flex-col" style={{ height: '100vh', overflow: 'hidden', backgroundColor: C.editorBg }}>
            ...
            <div className="flex items-center justify-between px-4 shrink-0"
                ...
                {/* Mode tabs */}
                <div className="flex items-center shrink-0 rounded-xl p-0.5"
                    style={{ backgroundColor: C.bg, border: `1px solid ${C.border}` }}>
                    <button onClick={() => setActiveMode('code')}
                        className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-[12px] font-semibold transition-all"
                        style={{ backgroundColor: activeMode === 'code' ? C.primary : 'transparent', color: activeMode === 'code' ? '#fff' : C.secondary, border: 'none', cursor: 'pointer', fontFamily: 'DM Sans, sans-serif' }}>
                        <Code2 size={13} /> HTML Code Editor
                    </button>
                    <button onClick={() => setActiveMode('visual')}
                        className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-[12px] font-semibold transition-all"
                        style={{ backgroundColor: activeMode === 'visual' ? C.primary : 'transparent', color: activeMode === 'visual' ? '#fff' : C.secondary, border: 'none', cursor: 'pointer', fontFamily: 'DM Sans, sans-serif' }}>
                        <Layers size={13} /> Visual Drag-&-Drop Editor
                    </button>
                </div>
