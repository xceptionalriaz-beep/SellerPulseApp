...
class RevenueAnalyticsTab extends StatelessWidget {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Center(
            child: SizedBox(
              height: 200, width: 200, // ✨ CHART TALLER AND WIDER
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          SizedBox(
            height: 260, // ✨ INCREASED HEIGHT TO BLOCK EMPTY SPACE
            child: Row(
              crossAxisAlignment: CrossAxisAlignment.end,
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
      ...
      child: Column(
        ...
        children: [
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: [
              const Text("True Profit & Loss (P&L)", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Colors.white)),
      ...
      child: Column(
        ...
        children: [
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: [
              const Text("Chargeback & Dispute Defense Center", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Color(0xFF0F172A))),
      ...
      child: Column(
        ...
        children: [
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: [
              const Text("Global Tax & VAT Compliance", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Color(0xFF0F172A))),
              Container(padding: const EdgeInsets.symmetric(horizontal: 10, vertical: 4), decoration: BoxDecoration(color: const Color(0xFFFFFBEB), borderRadius: BorderRadius.circular(20)), child: const Row(children: [Icon(Icons.warning_amber_rounded, size: 14, color: Colors.orange), SizedBox(width: 4), Text("1 Approaching Limit", style: TextStyle(color: Colors.orange, fontSize: 12, fontWeight: FontWeight.bold))])),
            ],
          ),
          const SizedBox(height: 4),
  ...
  // ✨ WIDER HEATMAP (Filled with more countries to block empty vertical space!)
  Widget _buildGeographicHeatmap() {
    return Container(
      width: double.infinity, // ✨ FORCE WIDGET TO FILL ALL HORIZONTAL SPACE!
      padding: const EdgeInsets.all(24),
      ...
      children: [
        Row(
          ...
          children: [
            ...
            Row(
              children: [
                Text(users, style: const TextStyle(color: Colors.white70, fontSize: 11)), // Added User Count!
                const SizedBox(width: 12),
